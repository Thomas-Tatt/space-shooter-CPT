...
def on_countdown_end():
    game.splash("Thanks for playing the Demo!")
    pause(5000)
    game.over(True)
...
"""))
game.splash("Hello Player! welcome to my Game!")
game.splash("The objective is to destroy the enemy ships")
game.splash("you only have one life!")
...
mySprite = sprites.create(img("""
    ...
    """),
    SpriteKind.player)
mySprite.set_position(74, 109)
controller.move_sprite(mySprite, 250, 250)
...
animation.run_image_animation(mySprite,
    [img("""
            . . . . . . . f f . . . . . . . 
                ...
                . f 5 f . . f 2 8 f . . f . f . 
                . f 5 f . . f 2 8 f . . f . f . 
                . f 2 f . f 2 2 8 8 f . f 8 f . 
                . f 2 f f 2 2 2 8 8 8 f f 8 f . 
                f f 2 2 2 2 2 2 8 8 8 8 8 8 8 f 
                f 2 2 2 2 2 2 2 8 8 8 8 8 8 8 f 
                f f f f f f f 2 8 f f f f f f f 
                . . . . . . f 2 8 f . . . . . . 
                . . . . . f 2 2 8 8 f . . . . . 
                . . . . f 2 2 2 8 8 8 f . . . . 
                . . . . f 2 2 2 8 8 8 f . . . . 
        ...
        img("""
            . . . . . . . f f . . . . . . . 
                ...
                . f . f . . f 8 2 f . . f 5 f . 
                . f . f . . f 8 2 f . . f 5 f . 
                . f 8 f . f 8 8 2 2 f . f f f . 
                . f 8 f f 8 8 8 2 2 2 f f f f . 
                f 8 8 8 8 8 8 8 2 2 2 2 2 2 2 f 
                f 8 8 8 8 8 8 8 2 2 2 2 2 2 2 f 
                f f f f f f f 8 2 f f f f f f f 
                . . . . . . f 8 2 f . . . . . . 
                . . . . . f 8 8 2 2 f . . . . . 
                . . . . f 8 8 8 2 2 f f . . . . 
                . . . . f 8 8 8 2 2 2 f . . . . 
...
def on_update_interval():
    ...
    othersprite = sprites.create(img("""
        ...
        """),
        SpriteKind.enemy)
    othersprite.set_position(randint(0, scene.screen_width()), 0)
